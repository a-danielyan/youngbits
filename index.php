...
define('IP_DEBUG', true);//env_bool('ENABLE_DEBUG'));
define('SUMEX_URL', env('SUMEX_URL'));


define('USE_QUOTES', true);
define('USE_OFFERS', false);

/*define('TYPE_ADMIN', '1');
define('TYPE_QUEST', '2');
define('TYPE_NORMAL_USER', '3');

define('TYPE_MANAGERS', '5');
define('TYPE_INTERNS', '6');
define('TYPE_FREELANCERS', '7');
define('TYPE_ADMINISTRATORS', '8');
define('TYPE_EMPLOYEES', '9');
define('TYPE_JOB_INTERVIEWS', '10');*/


define('TYPE_ADMIN', '1');
define('TYPE_MANAGERS', '2');
define('TYPE_FREELANCERS', '3');
define('TYPE_EMPLOYEES', '4');
define('TYPE_ADMINISTRATOR', '5'); // administrator
define('TYPE_ACCOUNTANT', '6');
define('TYPE_SALESPERSON', '7');
define('TYPE_PROMOTERS', '8');
define('TYPE_CLIENTS', '9');
