...
<main>
    ...
    <div class="company invoice-details clearfix">
        <table>
            <tr>
    ...
    <h2 class="invoice-extra-description" style="color: #375bc8; font-weight: normal"><?= $invoice->invoice_extra_description; ?></h2>
