    ...
    <div class="screen-12">
        ...
        <p>
            <?php if ($offer->client_address_1_delivery) {
                echo htmlsc($offer->client_address_1_delivery) . '<br>';
            } ?>
            <?php if ($offer->client_address_2_delivery) {
                echo htmlsc($offer->client_address_2_delivery) . '<br>';
            } ?>
            <?php if ($offer->client_city_delivery) {
                echo htmlsc($offer->client_city_delivery) . ' ';
            } ?>
            <?php if ($offer->client_state_delivery) {
                echo htmlsc($offer->client_state_delivery) . ' ';
            } ?>
            <?php if ($offer->client_zip_delivery) {
                echo htmlsc($offer->client_zip_delivery) . '<br>';
            } ?>
            <?php if ($offer->client_country_delivery) {
                echo htmlsc(get_country_name(trans('cldr'), $offer->client_country_delivery)) . '<br>';
            } ?>
        </p>
    </div>
