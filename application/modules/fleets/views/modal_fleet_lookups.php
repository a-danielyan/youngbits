    ...
    $(function () {
        ...
        $('.item-task-id').each(function () {
            ...
            if (currentVal.length) {
                selectedNotes.push(parseInt(currentVal));
            }
        });
        ...
        $('.modal-task-id').each(function () {
            ...
            if (selectedNotes.indexOf(currentId) !== -1) {
//                $('#task-id-' + currentId).prop('disabled', true);
        ...
        if (hiddenNotes >= $('.task-row').length) {
        ...
        $('.select-items-confirm').click(function () {
            ...
            $.post("<?php echo site_url('notes/ajax/process_task_selections'); ?>", {
                task_ids: task_ids
            }, function (data) {
