<div class="table-responsive">
    <table class="table table-striped">
        ...
        <thead>
        <tr>
            <th><input type="checkbox" class="checkAllSelExpenses"></th>
            ...
            <th><a <?= orderableTH($this->input->get(), 'expenses_cash_bank', 'ip_expenses'); ?>><?= _trans('type'); ?></a></th>
        ...
        <?php foreach ($records as $expense) { ?>
            <tr>
                <td>
                    <input type="checkbox" value="<?= $expense->expenses_id ?>" class="selExpenses <?=($expense->expenses_currency == 'dollar')? 'selDollar' : 'selEuro' ; ?>" data-amount="<?=($expense->expenses_currency == 'dollar')? format_amount($expense->expenses_amount) : format_amount($expense->expenses_amount_euro) ; ?>">
                </td>
                    ...
                    <td>
                        <div class="options btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="<?php echo site_url('expenses/form/' . $expense->expenses_id); ?>">
                                        <i class="fa fa-edit fa-margin"></i>
                                        <?php _trans('edit'); ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('expenses/delete/' . $expense->expenses_id); ?>"
...
<input type="hidden" name="url" value="<?=base_url().'index.php/expenses/'?>">