<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div id="content">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" name="expenses_category" id="expenses_category" class="form-control"
                       value="<?=$expenses->expenses_category ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <select name="expenses_currency" id="expenses_currency" class="form-control simple-select">
                    ...
                    <option value="dollar"  <?=($expenses->expenses_currency == 'dollar')? 'selected' : '' ;?> >$  <?php _trans('dollar'); ?></option>
                    <option value="euro"    <?=($expenses->expenses_currency == 'euro')? 'selected' : '' ;?> >€ <?php _trans('euro'); ?></option>
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="input-group">
                    <input  min="0" step="0.01" name="expenses_amount" id="expenses_amount" class="form-control"
                           value="<?php echo format_amount($expenses->expenses_amount); ?>">
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="input-group">
                    <input min="0" step="0.01" name="expenses_amount_euro" id="expenses_amount_euro" class="form-control"
                           value="<?php echo format_amount($expenses->expenses_amount_euro); ?>">
                    <div class="input-group-addon">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <textarea name="expenses_notes"
                          class="form-control"><?=$expenses->expenses_notes; ?></textarea>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <select name="expenses_parent_id" id="expenses_parent_id" class="form-control simple-select" >
                    ...
                    <?php foreach ($expenses_list as $expens) { ?>
                        <option value="<?=$expens->expenses_id; ?>"
                            <?php check_select($expens->expenses_id, $expenses->expenses_parent_id);?>>
        ...
        <!--<div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" name="expenses_cash_bank" id="expenses_cash_bank" class="form-control"
                       value="<?/*=$expenses->expenses_cash_bank */?>">
            </div>
        </div>-->
            ...
            <div class="col-xs-12 col-sm-6">
                <select name="expenses_cash_bank" id="expenses_cash_bank" class="form-control simple-select" >
                    <?php foreach ($cash_banks as $key => $cash_bank) { ?>
                        <option value="<?=$key; ?>"
                            <?php check_select($key, $expens->expenses_cash_bank);?>>
                            <?=$cash_bank;?>
                        </option>
                    <?php } ?>
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6 text-left">
                <input type="checkbox" name="exclude_from_total" id="exclude_from_total" style="width: 30px; height: 30px"
                      <?=$expenses->exclude_from_total ? 'checked' : '' ?>>
            </div>
        </div>
