            ...
            <div class="panel panel-default no-margin">
                ...
                <div class="panel-body table-content">
                    <table class="table no-margin">
                        ...
                        <tr>
                            <th><?php _trans('ticket_description'); ?></th>
                            <td><?php _htmlsc($ticket->ticket_description); ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo anchor('users/form/' . $ticket->ticket_created_user_id, $ticket->ticket_created_user_name); ?></td>
                        </tr>
                        <tr>
