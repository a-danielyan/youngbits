<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div id="content">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" name="inventory_post_title" id="inventory_post_title" class="form-control"
                       value="<?=$inventory->inventory_post_title; ?>">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <textarea name="inventory_post_content"
                          class="form-control"><?= $inventory->inventory_post_content; ?></textarea>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="input-group">
                    <input type="number" name="inventory_sale_price" id="inventory_sale_price" class="form-control"
                           value="<?php echo format_amount($inventory->inventory_sale_price); ?>">
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="input-group">
                    <input type="number" name="inventory_regular_price" id="inventory_regular_price" class="form-control"
                           value="<?php echo format_amount($inventory->inventory_regular_price); ?>">
                    <div class="input-group-addon">
                        <?php echo get_setting('currency_symbol') ?>
                    </div>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" name="inventory_size" id="inventory_size" class="form-control"
                       value="<?= $inventory->inventory_size; ?>">
            </div>
        </div>
        <div class="form-group">
            <div class="col-xs-12 col-sm-2 text-right text-left-xs">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" name="inventory_weight" id="inventory_weight" class="form-control"
                       value="<?= $inventory->inventory_weight; ?>">
            </div>
        </div>
        <div class="form-group">
            <div class="col-xs-12 col-sm-2 text-right text-left-xs">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="number" name="inventory_length" id="inventory_length" class="form-control"
                       value="<?= $inventory->inventory_length; ?>">
            </div>
        </div>
        <div class="form-group">
            <div class="col-xs-12 col-sm-2 text-right text-left-xs">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="number" name="inventory_width" id="inventory_width" class="form-control"
                       value="<?= $inventory->inventory_width; ?>">
            </div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-1">
                <label><?php _trans('enable'); ?> &nbsp
                    <input type="checkbox" class="inventory_manage_stock" name="inventory_manage_stock" value="yes" <?php if($inventory->inventory_manage_stock == 'yes'){ echo 'checked';}; ?>>
                </label>
            </div>
        </div>

        <div class="inventory_stock_quantity  <?php if($inventory->inventory_manage_stock != 'yes'){ echo 'd-none';}; ?> ">
            <div class="form-group">
                <div class="col-xs-12 col-sm-2 text-right text-left-xs">
                ...
                <div class="col-xs-12 col-sm-6">
                    <input type="number" name="inventory_stock_quantity" id="inventory_stock_quantity" class="form-control"
                           value="<?= $inventory->inventory_stock_quantity; ?>">
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" name="inventory_product_url" id="inventory_product_url" class="form-control"
                       value="<?= $inventory->inventory_product_url; ?>">
            </div>
        </div>
            ...
            <div class="col-xs-12 col-sm-6 payment-method-wrapper">
                <select id="inventory_category" name="inventory_category" class="form-control simple-select">
                    <?php foreach ($categories as $key => $category) { ?>
                        <option value="<?=$key; ?>"
                                <?php if ($inventory->inventory_category == $key) { ?> selected="selected" <?php } ?>>
                            <?=$category; ?>
                        </option>
                    <?php } ?>
                </select>
            ...
            <div class="col-xs-12 col-sm-6 payment-method-wrapper">
                <select id="inventory_percentage_user" name="inventory_percentage_user" class="form-control simple-select">
                    <?php foreach ($percentage_users as $key => $percentage_user) { ?>
                        <option value="<?=$key; ?>"
                                <?php if ($inventory->inventory_percentage_user == $key) { ?>selected="selected"<?php } ?>>
                            <?=$percentage_user; ?> %
                        </option>
                    <?php } ?>
                </select>
            ...
            <div class="col-xs-12 col-sm-6">
                <select name="inventory_status" id="inventory_status" class="form-control simple-select" >
                    <?php foreach ($inventory_statuses as $key => $status) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php check_select($key, $inventory->inventory_status); ?>>
                ...
                <select name="inventory_project_id" id="inventory_project_id" class="form-control simple-select">
                    ...
                    <?php foreach ($projects as $project) { ?>
                        <option value="<?=$project->project_id; ?>"
                            <?php check_select($inventory->inventory_project_id, $project->project_id); ?>>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" name="inventory_country" id="inventory_country" class="form-control"
                       value="<?= $inventory->inventory_country; ?>">
            </div>
        </div>
        ...
        <div class="form-group has-feedback">
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="input-group">
                    <input name="inventory_date" id="inventory_date" class="form-control" value="<?php echo date_from_mysql($inventory->inventory_date); ?>" readonly>
        ...
        <div class="row form-group">
            ...
            <div class="col-md-1">
                <label><?php _trans('no'); ?> &nbsp
                    <input type="radio" class="inventory_sell_product_now" name="inventory_sold" value="no" <?php if($inventory->inventory_sold == 'no'){ echo 'checked';}; ?>>
                </label>
            </div>
            <div class="col-md-1">
                <label><?php _trans('yes'); ?> &nbsp
                    <input type="radio" class="inventory_sell_product_now" name="inventory_sold" value="yes" <?php if($inventory->inventory_sold == 'yes'){ echo 'checked';}; ?>>
                </label>
            </div>
        </div>
        ...
        <?php if($inventory->inventory_created_user == 0){
            ?>
