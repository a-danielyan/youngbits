<?php
    $appointment_id = $this->mdl_appointments->form_value('appointment_id');
    $base_url = base_url();

if ($this->mdl_appointments->form_value('appointment_id') && ($this->mdl_appointments->form_value('appointment_status') == 4 || $this->mdl_appointments->form_value('appointment_status') == 5)) :
    ?>
...
<form method="post" enctype="multipart/form-data" id="appointment-form">
    ...
    <div id="headerbar">
        <div class="row">
           ...
           <?php if(!empty($appointment_templates)): ?>
               <div class="col-md-2">
                   <select name="appointment_templates" id="appointment_templates" class="form-control simple-select">
                       <option value=""><?php _trans('appointments_select_template'); ?></option>
    ...
    <div id="content">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <?php if ($this->mdl_appointments->form_value('appointment_id')) : ?>
                            #<?php echo $this->mdl_appointments->form_value('appointment_id'); ?>&nbsp;
                            <?php echo $this->mdl_appointments->form_value('appointment_name', true); ?>
                        <?php else : ?>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="appointment_title" id="appointment_title" class="form-control"
                                   value="<?php echo $this->mdl_appointments->form_value('appointment_title'); ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="appointment_type" id="appointment_type" class="form-control"
                                   value="<?php echo $this->mdl_appointments->form_value('appointment_type'); ?>">
                        </div>
                            ...
                            <select name="appointment_client_id" id="appointment_client_id" class="form-control simple-select">
                                ...
                                <?php foreach ($users as $user) { ?>
                                    <option value="<?php echo $user->user_id; ?>"
                                        <?php check_select($this->mdl_appointments->form_value('appointment_client_id'), $user->user_id); ?>>
                        ...
                        <div class="form-group">
                            ...
                            ><?php echo $this->mdl_appointments->form_value('appointment_description', true); ?></textarea>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-2">
                                <label><?php _trans('no'); ?> &nbsp
                                    <input type="radio" class="appointment_recurring_checked" name="appointment_recurring_checked" value="0" <?php if($this->mdl_appointments->form_value('appointment_recurring_checked') == 0){ echo 'checked';}; ?>>
                                </label>
                            </div>
                            <div class="col-md-3">
                                <label><?php _trans('yes'); ?> &nbsp
                                    <input type="radio" class="appointment_recurring_checked" name="appointment_recurring_checked" value="1" <?php if($this->mdl_appointments->form_value('appointment_recurring_checked') == 1){ echo 'checked';}; ?>>
                                </label>
                            </div>
                        </div>

                        <div class="row form-group">
                            <div class="recuring-period recurring_checked <?= ($this->mdl_appointments->form_value('appointment_recurring_checked') == 0) ? 'hidden' : '' ?>">
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        <select name="appointment_recurring" id="appointment_recurring" class="form-control simple-select">
                                            <?php foreach ($recur_frequencies as $key => $lang) { ?>
                                                ...
                                                <?php if($key == $this->mdl_appointments->form_value('appointment_recurring')){
                                                    ?>
                            ...
                            <div class=" form-group">
                                <div class="recuring-period  <?= ($this->mdl_appointments->form_value('appointment_recurring_checked') == 0) ? 'hidden' : '' ?>">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input name="appointments_recur_start_date" id="appointments_recur_start_date" class="form-control datepicker"
                                                   value="<?php echo date_from_mysql($this->mdl_appointments->form_value('appointments_recur_start_date')); ?>">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input name="appointments_recur_end_date" id="appointments_recur_end_date" class="form-control datepicker"
                                                   value="<?php echo date_from_mysql($this->mdl_appointments->form_value('appointments_recur_end_date')); ?>">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar fa-fw"></i>
                                            </div>
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="appointment_address" id="appointment_address" class="form-control"
                                   value="<?php echo $this->mdl_appointments->form_value('appointment_address', true); ?>">
                        ...
                        <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="appointment_departure_location" id="appointment_departure_location" class="form-control"
                                               value="<?php echo $this->mdl_appointments->form_value('appointment_departure_location'); ?>">
                                        <div class="input-group-addon">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="time" name="appointment_pickup_start_time" id="appointment_pickup_start_time" class="form-control"
                                               value="<?php echo $this->mdl_appointments->form_value('appointment_pickup_start_time'); ?>">
                                        <div class="input-group-addon">
                            ...
                            <div class="stop_during_ride">
                                <?php if(!empty($this->mdl_appointments->form_value('appointment_pickup_stop_time'))){ ?>
                                    <div class="row form-group">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="appointment_stop_during_ride" id="stop_during_ride" class="form-control"
                                                       value="<?php echo $this->mdl_appointments->form_value('appointment_stop_during_ride'); ?>">
                                                <div class="input-group-addon">
                                                    <i class="fa fa-plane" aria-hidden="true"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input type="time" name="appointment_pickup_stop_time" id="appointment_pickup_stop_time" class="form-control"
                                                       value="<?php echo $this->mdl_appointments->form_value('appointment_pickup_stop_time'); ?>">
                                                <div class="input-group-addon">
                                                    <i class="fa fa-clock-o fa-fw"></i>
                                                </div>
                                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="appointment_departure_end_location" id="appointment_departure_end_location" class="form-control"
                                           value="<?php /*echo $this->mdl_appointments->form_value('appointment_departure_end_location'); */?>">
                                    <div class="input-group-addon">
                                        <i class="fa fa-plane" aria-hidden="true"></i>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="time" name="appointment_pickup_end_time" id="appointment_pickup_end_time" class="form-control"
                                           value="<?php /*echo $this->mdl_appointments->form_value('appointment_pickup_end_time'); */?>">
                                    <div class="input-group-addon">
                                        <i class="fa fa-clock-o fa-fw"></i>
                                    </div>
                                </div>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="input-group">
                                <input name="appointment_date" id="appointment_date" class="form-control datepicker"
                                       value="<?php echo date_from_mysql($this->mdl_appointments->form_value('appointment_date')); ?>">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar fa-fw"></i>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="time" name="appointment_starting_time" id="appointment_starting_time" class="form-control"
                                           value="<?php echo $this->mdl_appointments->form_value('appointment_starting_time'); ?>">
                                    <div class="input-group-addon">
                                        <i class="fa fa-clock-o fa-fw"></i>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="time" name="appointment_end_time" id="appointment_end_time" class="form-control"
                                           value="<?php echo $this->mdl_appointments->form_value('appointment_end_time'); ?>">
                                    <div class="input-group-addon">
                                        <i class="fa fa-clock-o fa-fw"></i>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" name="appointment_total_time_of" readonly id="appointment_total_time_of" class="form-control text-right"
                                       value="<?php echo $this->mdl_appointments->form_value('appointment_total_time_of', false); ?>">
                                <div class="input-group-addon">
                                    <i class="fa fa-clock-o fa-fw"></i>
                                </div>
                            </div>
                    ...
                    <?php if (!is_null($this->mdl_appointments->form_value('appointment_url_key')) && !empty($this->mdl_appointments->form_value('appointment_url_key'))) { ?>
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="appointment_url_key" readonly id="appointment_url_key" class="form-control"
                                               value="<?php echo site_url('guest/view/appointment/' .$this->mdl_appointments->form_value('appointment_url_key', false)) ?>">
            ...
            <div class="col-xs-12 col-sm-6 ">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                            ...
                            <select name="project_id" id="project_id" class="form-control simple-select">
                                ...
                                <?php foreach ($projects as $project) { ?>
                                    <option value="<?=$project->project_id; ?>"
                                        <?php check_select($this->mdl_appointments->form_value('project_id'), $project->project_id); ?> >
                        ...
                        <div class="form-group">
                            ...
                            <select name="appointment_status" id="appointment_status" class="form-control simple-select">
                                <?php foreach ($appointment_statuses as $key => $status) {
                                    if ($this->mdl_appointments->form_value('appointment_status') != 4 && ($key == 4 || $key == 5)) {
                                        continue;
                                    } ?>
                                    <option value="<?php echo $key; ?>" <?php check_select($key, $this->mdl_appointments->form_value('appointment_status')); ?>>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-2">
                                <label><?php _trans('no'); ?> &nbsp
                                    <input type="radio" class="appointment_invoice_checked" name="appointment_invoice_checked" value="0"  <?php if($this->mdl_appointments->form_value('appointment_invoice_checked') == 0){ echo 'checked';}; ?>>
                                </label>
                            </div>
                            <div class="col-md-3">
                                <label><?php _trans('yes'); ?> &nbsp
                                    <input type="radio" class="appointment_invoice_checked" name="appointment_invoice_checked" value="1"  <?php if($this->mdl_appointments->form_value('appointment_invoice_checked') == 1){ echo 'checked';}; ?>>
                                </label>
                            </div>
                        </div>

                        <div class="form-group sel <?php if($this->mdl_appointments->form_value('appointment_invoice_checked') == 0){ echo 'hidden';}; ?> ">
                            ...
                            <select name="appointment_product_id" id="appointment_recurring" class="form-control simple-select">
                                ...
                                <?php foreach ($products as $product) { ?>
                                    <option value="<?=$product->product_id; ?>"
                                        <?php check_select($this->mdl_appointments->form_value('appointment_product_id'), $product->product_id); ?>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-2">
                                <label><?php _trans('no'); ?> &nbsp
                                    <input type="radio" name="appointment_carpool_checked" value="0" <?php if($this->mdl_appointments->form_value('appointment_carpool_checked') == 0){ echo 'checked';}; ?>>
                                </label>
                            </div>
                            <div class="col-md-3">
                                <label><?php _trans('yes'); ?> &nbsp
                                    <input type="radio" name="appointment_carpool_checked" value="1" <?php if($this->mdl_appointments->form_value('appointment_carpool_checked') == 1){ echo 'checked';}; ?>>
                                </label>
                            </div>
                        </div>

                        <div class="panel panel-default">
                            <div class="form-group  appointment_carpool_checked recuring-period <?= ($this->mdl_appointments->form_value('appointment_carpool_checked') == 0) ? 'hidden' : '' ?>">
                                <div class="panel-heading">
                                    <div class="col text-right">
                                        <button type="button" class="btn btn-info" name="add_stop_during" <?php if(!empty($this->mdl_appointments->form_value('appointment_pickup_stop_time'))){ echo 'disabled'; } ?>>+ Add stop during ride</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md">
                                <div class="col-sm-10 no-padding">
                                    <input type="text" name="appointment_url_document" id="appointment_url_document" class="form-control" readonly
                                           value="<?php echo $this->mdl_appointments->form_value('appointment_url_document'); ?>">
                                </div>
                ...
                <?php if(empty($this->mdl_appointments->form_value('default_hour_rate', true)) || $this->mdl_appointments->form_value('default_hour_rate', true) == 0){
                    ?>
                    <input type="hidden" name="default_hour_rate" id="default_hour_rate" class="amount form-control"
                           value="<?php echo $this->mdl_appointments->form_value('default_hour_rate', true); ?>">
                <?php }else{?>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body appointment_visiting_people">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="appointment_kilometers" id="appointment_kilometers" class="form-control change"
                                   value="<?php echo $this->mdl_appointments->form_value('appointment_kilometers', true); ?>" min = '0'>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-2">
                                <label><?php _trans('no'); ?> &nbsp
                                    <input type="radio" name="appointment_invoice_kilometer_checked" value="0" <?php if($this->mdl_appointments->form_value('appointment_invoice_kilometer_checked') == 0){ echo 'checked';}; ?>>
                                </label>
                            </div>
                            <div class="col-md-3">
                                <label><?php _trans('yes'); ?> &nbsp
                                    <input type="radio" name="appointment_invoice_kilometer_checked" value="1" <?php if($this->mdl_appointments->form_value('appointment_invoice_kilometer_checked') == 1){ echo 'checked';}; ?>>
                                </label>
                            </div>
                        </div>

                        <div class="form-group  kilometer_checked recuring-period <?= ($this->mdl_appointments->form_value('appointment_invoice_kilometer_checked') == 0) ? 'hidden' : '' ?>"">
                        ...
                        <div class="input-group">
                            <input type="number" name="appointment_price_per_kilometer" step="0.01" min="0" id="appointment_price_per_kilometer" class="form-control change"
                                   value="<?php echo $this->mdl_appointments->form_value('appointment_price_per_kilometer', true); ?>">
                            <div class="input-group-addon">
                                <?php echo get_setting('currency_symbol') ?>
                            </div>
                        </div>
                        <input type="hidden" name="appointment_price_kilometor_total" value="<?php echo $this->mdl_appointments->form_value('appointment_total_price_kilometer', true); ?>">
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-2">
                            <label><?php _trans('no'); ?> &nbsp
                                <input type="radio" name="appointment_stayawaykey_checked" value="0" <?php if($this->mdl_appointments->form_value('appointment_stayawaykey_checked') == 0){ echo 'checked';}; ?>>
                            </label>
                        </div>
                        <div class="col-md-3">
                            <label><?php _trans('yes'); ?> &nbsp
                                <input type="radio" name="appointment_stayawaykey_checked" value="1" <?php if($this->mdl_appointments->form_value('appointment_stayawaykey_checked') == 1){ echo 'checked';}; ?>>
                            </label>
                        </div>
                    </div>

                    <div class="row form-group stayawaykey_checked <?php if($this->mdl_appointments->form_value('appointment_stayawaykey_checked') == 0){ echo 'hidden';}; ?>">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" name="appointment_starting_price_per_kilometer" step="0.01" min="0" id="appointment_starting_price_per_kilometer" class="change form-control"
                                       value="<?php echo $this->mdl_appointments->form_value('appointment_starting_price_per_kilometer'); ?>">
                                <div class="input-group-addon">
                                    €
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" name="appointment_stayawaykey_price_per_kilometer" step="0.01" min="0" id="appointment_stayawaykey_price_per_kilometer" class="form-control change"
                                       value="<?php echo $this->mdl_appointments->form_value('appointment_stayawaykey_price_per_kilometer'); ?>">
                                <div class="input-group-addon">
                                    €
                                </div>
                            </div>
                    ...
                    <div class="form-group stayawaykey_checked  <?php if($this->mdl_appointments->form_value('appointment_stayawaykey_checked') == 0){ echo 'hidden';}; ?>">
                        ...
                        <input type="number" name="appointment_how_many_seats_can_you_offer"  min="0" id="appointment_how_many_seats_can_you_offer" class="form-control change"
                               value="<?php echo $this->mdl_appointments->form_value('appointment_how_many_seats_can_you_offer', true); ?>">

                        <input type="hidden" name="user_tax_rate" class="change" value="<?=$user->user_price_per_kilometer?>">
                        <input type="hidden" name="appointment_price_kilometor_total" value="<?php echo $this->mdl_appointments->form_value('appointment_total_price_kilometer', true); ?>">
                        <input type="hidden" name="appointment_stayawaykey_price_kilometor_total" value="<?php echo $this->mdl_appointments->form_value('appointment_stayawaykey_price_kilometor_total', true); ?>">
                    </div>
              ...
              <div id="appointment_add_people">
                ...
                <input type="hidden" name="appointment_price" value="<?=$this->mdl_appointments->form_value('appointment_price', true); ?>">
                <input type="hidden" name="appointment_user_id" value="<?=empty($this->mdl_appointments->form_value('appointment_user_id'))?$this->session->userdata('user_id'): $this->mdl_appointments->form_value('appointment_user_id'); ?>">
                </div>
...
'                        </div><button type="button" class="btn btn-info add_new_person" name="delete">Add</button></div>');
            ...
            $(document).on('change','#appointment_templates',function(){
