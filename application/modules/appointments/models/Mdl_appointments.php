...
/**
 * Class Mdl_Appointments
 */
class Mdl_Appointments extends Response_Model
{
    public $table = 'ip_appointments';
    public $primary_key = 'ip_appointments.appointment_id';
    ...
    {
        $this->db->join('ip_projects', 'ip_projects.project_id = ip_appointments.project_id', 'left');
        $this->db->join('ip_users', 'ip_users.user_id = ip_appointments.appointment_user_id', 'left');
        $this->db->join('ip_products', 'ip_products.product_id = ip_appointments.appointment_product_id', 'left');
    }

    public function get_latest()
    {
        $this->db->order_by('ip_appointments.appointment_id', 'DESC');
        return $this;
    }
    ...
    public function db_array()
    {
        ...
        $db_array['appointment_pickup_start_time'] = $_POST['appointment_pickup_start_time'];
        $db_array['appointment_departure_end_location'] = '';
        $db_array['appointment_stop_during_ride'] = $this->input->post('appointment_stop_during_ride');
        $db_array['appointment_pickup_end_time'] = '';
        ...
        $db_array['appointment_user_id'] = $this->input->post('appointment_user_id');
        ...
        $db_array['appointments_recur_start_date'] = $this->input->post('appointments_recur_start_date');

        $db_array['appointments_recur_end_date'] = $this->input->post('appointments_recur_end_date');
        $db_array['appointment_date'] =(!empty($_POST['appointment_date']))?date_to_mysql($this->input->post('appointment_date'))  : 0 ;
        ...
        if(empty($this->input->post('appointment_url_key'))){
            $db_array['appointment_url_key'] =$this->get_url_key();
        }
        ...
        if(isset($_POST['appointment_kilometers'])){
