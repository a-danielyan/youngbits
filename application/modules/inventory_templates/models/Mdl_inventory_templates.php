 ...
 * Class Mdl_Inventory
 */
class Mdl_inventory_templates extends Response_Model
{
    public $table = 'ip_inventory_templates';
    public $primary_key = 'ip_inventory_templates.inventory_id';
    ...
    public function default_select()
    {
        $this->db->select("
            SQL_CALC_FOUND_ROWS
            ip_inventory_templates.*,ip_projects.project_name,ip_users.user_name", false);
    }
    ...
    public function default_order_by()
    {
        ...
        $orderTable = $this->input->get('table') ? ($this->input->get('table') === 'INDEPENDENT' ? '' : $this->input->get('table').'.') : 'ip_inventory_templates.';
        $this->db->order_by($orderTable.$orderField.' '.$orderType);
    }

    public function default_join()
    {
        $this->db->join('ip_projects', 'ip_projects.project_id = ip_inventory_templates.inventory_project_id', 'left');
        $this->db->join('ip_users', 'ip_users.user_id = ip_inventory_templates.inventory_created_user', 'left');
    }
    ...
    public function db_array()
    {
        ...
        $db_array['inventory_date'] = date('Y-m-d', strtotime($db_array['inventory_date']));
