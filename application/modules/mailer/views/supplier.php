...
<form method="post" action="<?php echo site_url('mailer/supplier_email_address') ?>">
    <input type="hidden" name="<?php echo $this->config->item('csrf_token_name'); ?>"
           value="<?php echo $this->security->get_csrf_hash() ?>">

    <div id="headerbar">
        <h1 class="headerbar-title"><?php _trans('email_supplier'); ?></h1>
    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-6">
                ...
                <?php $this->layout->load_view('email_templates/template-tags-supplier'); ?>
