...
<form method="post" action="<?php echo site_url('mailer/send_ticket/' . $ticket->ticket_id) ?>">
    <input type="hidden" name="<?php echo $this->config->item('csrf_token_name'); ?>"
           value="<?php echo $this->security->get_csrf_hash() ?>">

    <div id="headerbar">
        <h1 class="headerbar-title"><?php _trans('email_ticket'); ?></h1>
            ...
            <div class="col-xs-12 col-md-8 col-md-offset-2">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="to_email" id="to_email" class="form-control" required
                           value="<?php echo $client ? $client->client_email : ''; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="from_name" id="from_name" class="form-control"
                           value="<?php !empty($user)?_htmlsc($user->user_name) : ""; ?>">
                </div>

                <div class="form-group">
                    <label for="from_email"><?php _trans('from_email'); ?></label>
                    <input type="email" name="from_email" id="from_email" class="form-control"
                           value="<?php if (!empty($user)) { echo $user->user_email; } ?>">
                </div>

                <div class="form-group">
                    <label for="cc"><?php _trans('cc'); ?></label>
                    <input type="text" name="cc" id="cc" value="<?php if (!empty($user)) {  $user->user_email; } ?>" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="subject" id="subject" class="form-control"
                           value="<?php echo trans('ticket') . ' #' . $ticket->ticket_id; ?>">
                </div>
            </div>
        </div>
