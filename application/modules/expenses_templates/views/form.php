<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div id="headerbar">
        <h1 class="headerbar-title"><?php _trans('expenses_templates_form'); ?></h1>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" name="expenses_name" id="expenses_name" class="form-control"
                       value="<?php echo $this->mdl_expenses_templates->form_value('expenses_name'); ?>">
            </div>
        </div>
        <div class="form-group">
            <div class="col-xs-12 col-sm-2 text-right text-left-xs">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" name="expenses_category" id="expenses_category" class="form-control"
                       value="<?php echo $this->mdl_expenses_templates->form_value('expenses_category'); ?>">
            </div>
        </div>
                ...
                <select name="expenses_project_id" id="expenses_project_id" class="form-control simple-select">
                    ...
                    <?php foreach ($projects as $project) { ?>
                        <option value="<?=$project->project_id; ?>"
                            <?php check_select($this->mdl_expenses_templates->form_value('expenses_project_id'), $project->project_id); ?>>
                ...
                <select name="expenses_user_id" id="expenses_user_id" class="form-control simple-select" >
                    ...
                    <?php foreach ($users as $user) { ?>
                        <option value="<?php echo $user->user_id; ?>"
                            <?php check_select($user->user_id, $this->mdl_expenses_templates->form_value('expenses_user_id'));?>>
                            <?=$user->user_name;?>
                        </option>
                    <?php } ?>
                </select>
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="input-group">
                    <input name="expenses_date" id="expenses_date"
                           ...
                           value="<?php echo date_from_mysql($this->mdl_expenses_templates->form_value('expenses_date')); ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <select name="expenses_currency" id="expenses_currency" class="form-control simple-select">
                    ...
                    <option value="dollar"  <?=($this->mdl_expenses_templates->form_value('expenses_currency') == 'dollar')? 'selected' : '' ;?> >$  <?php _trans('dollar'); ?></option>
                    <option value="euro" <?=($this->mdl_expenses_templates->form_value('expenses_currency') == 'euro')? 'selected' : '' ;?> >€ <?php _trans('euro'); ?></option>
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="input-group">
                    <input type="number" min="0" step="0.01" name="expenses_amount" id="expenses_amount" class="form-control"
                           value="<?php echo format_amount($this->mdl_expenses_templates->form_value('expenses_amount')); ?>">
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="input-group">
                    <input type="number" min="0" step="0.01" name="expenses_amount_euro" id="expenses_amount_euro" class="form-control"
                           value="<?php echo format_amount($this->mdl_expenses_templates->form_value('expenses_amount_euro')); ?>">
                    <div class="input-group-addon">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <textarea name="expenses_notes"
                          class="form-control"><?php echo $this->mdl_expenses_templates->form_value('expenses_notes', true); ?></textarea>
            </div>
                ...
                <select name="expenses_parent_id" id="expenses_parent_id" class="form-control simple-select" >
                    ...
                    <?php foreach ($expenses as $expens) { ?>
                        <option value="<?=$expens->expenses_id; ?>"
                            <?php check_select($expens->expenses_id, $this->mdl_expenses_templates->form_value('expenses_parent_id'));?>>
            ...
            <div class="col-xs-12 col-sm-6">
                <select name="expenses_cash_bank" id="expenses_cash_bank" class="form-control simple-select" >
                    <?php foreach ($cash_banks as $key => $cash_bank) { ?>
                        <option value="<?=$key; ?>"
                            <?php check_select($key, $this->mdl_expenses_templates->form_value('expenses_cash_bank'));?>>
                            <?=$cash_bank;?>
                        </option>
                    <?php } ?>
                </select>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" name="expenses_taxes" id="expenses_taxes" class="form-control"
                       value="<?php echo $this->mdl_expenses_templates->form_value('expenses_taxes'); ?>">
            </div>
        </div>
        <!--    END TAXES SECTION      -->
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6 text-left">
                <input type="checkbox" name="exclude_from_total" id="exclude_from_total" style="width: 30px; height: 30px"
                      <?php echo $this->mdl_expenses_templates->form_value('exclude_from_total') ? 'checked' : '' ?>>
            </div>
        </div>
