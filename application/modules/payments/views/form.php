...
<form method="post" class="form-horizontal">
    ...
    <div id="content">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="number" name="payment_amount" step="0.01" id="payment_amount" class="form-control"
                       value="<?=(!empty(format_amount($this->mdl_payments->form_value('payment_amount'))))?format_amount($this->mdl_payments->form_value('payment_amount')):0; ?>">
            </div>
        </div>
