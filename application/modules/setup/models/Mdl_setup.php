...
class Mdl_Setup extends CI_Model
{
    ...
    private function install_default_settings()
    {
        ...
        $default_settings = array(
            ...
            'pdf_invoice_template' => 'Spudu',
            'pdf_invoice_template_paid' => 'Spudu - paid',
            'pdf_invoice_template_overdue' => 'Spudu - overdue',
            'pdf_quote_template' => 'Spudu',
            'public_invoice_template' => 'Spudu_Web',
            'pdf_offer_template' => 'Spudu',
            'public_offer_template' => 'Spudu_Web',
            'public_quote_template' => 'Spudu_Web',
            'disable_sidebar' => 1,
        );
