<script>
    ...
    window.onload = function () {
        ...
        // Get the latest version from the Spudu IDS
        $.getJSON("https://ids.Spudu.com/updatecheck", function (data) {
        ...
        // Get the latest news
        $.getJSON("https://ids.Spudu.com/get_news", function (data) {
            <?php echo(IP_DEBUG ? 'console.log(data);' : ''); ?>
            setTimeout(function () {
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div id="updatecheck-results">
                ...
                <a href="https://Spudu.com/downloads" id="updatecheck-updates-available"
