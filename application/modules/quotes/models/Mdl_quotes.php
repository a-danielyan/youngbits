...
class Mdl_Quotes extends Response_Model
{
    ...
    public function default_order_by()
    {
        ...
        $orderField = $this->input->get('field') ? $this->input->get('field') : 'quote_id';
        $ip_invoices = $this->input->get('table') ? $this->input->get('table') : 'ip_quotes';
    ...
    public function default_join()
    {
        ...
        {
            $this->db->join('ip_clients_groups', 'ip_clients_groups.client_id = ip_quotes.client_id');
        }
    }
    ...
    public function validation_rules()
    {
        return array(
            ...
            'quote_company_id' => array(
                'field' => 'quote_company_id',
                'label' => trans('company'),
            ),
