    ...
    <div class="col-xs-12 col-md-6 col-md-offset-2 col-lg-4 col-lg-offset-4">
        <table class="table table-bordered text-right">
                ...
                <td class="clearfix">
                    <div class="discount-field">
                        <div class="input-group input-group-sm">
                            <input id="quote_discount_amounts" disabled name="quote_discount_amount"
                                   class=" form-control input-sm amount"
                                   value="<?php echo format_amount($quote->quote_discount_amount != 0 ? $quote->quote_discount_amount : $quote->quote_item_subtotal / 100 * $quote->quote_discount_percent); ?>">
            ...
            <tr>
                ...
                <td style="width: 60%;" class="amount"><?php echo format_currency($quote->quote_item_subtotal-( $quote->quote_item_subtotal / 100 * $quote->quote_discount_percent)); ?></td>
            </tr>
            <tr>
