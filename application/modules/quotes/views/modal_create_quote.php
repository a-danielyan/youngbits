    ...
    $(function () {
        ...
        $('#quote_create_confirm').click(function () {
            ...
            $.post("<?php echo site_url('quotes/ajax/create'); ?>", {
                    ...
                    quote_company_id: $('#quote_company_id').val(),
...
<div id="create-quote" class="modal modal-lg" role="dialog" aria-labelledby="modal_create_quote" aria-hidden="true">
    <form class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label for="quote_company_id"><?php _trans('company'); ?></label>
                <select name="quote_company_id" id="quote_company_id" class="form-control simple-select">
                    <?php foreach ($companies as $company) { ?>
                        <option value="<?php echo $company->id; ?>" <?= $company->default_company ? 'selected' : '' ?> >
                            <?php _htmlsc($company->name); ?>
                        </option>
                    <?php } ?>
                </select>
            </div>
