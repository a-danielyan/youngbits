<div id="headerbar">
    ...
    <h1 class="headerbar-title"><?php _trans('distributors'); ?></h1>
    ...
    <?php if(in_array($this->session->userdata('user_type'), array(TYPE_ADMIN,TYPE_MANAGERS,TYPE_SALESPERSON)) ){ ?>
        <div class="headerbar-item pull-right">
            ...
            <a class="btn btn-primary btn-sm" href="<?php echo site_url('distributors/form'); ?>">
    ...
    <div class="headerbar-item pull-right visible-lg">
        <div class="btn-group btn-group-sm index-options">
            <a href="<?php echo site_url('distributors/status/active/' . $filter_group); ?>"
               class="btn <?php echo $this->uri->segment(3) == 'active' || !$this->uri->segment(3) ? 'btn-primary' : 'btn-default' ?>">
                <?php _trans('active'); ?>
            </a>
            <a href="<?php echo site_url('distributors/status/inactive/' . $filter_group); ?>"
               class="btn  <?php echo $this->uri->segment(3) == 'inactive' ? 'btn-primary' : 'btn-default' ?>">
                <?php _trans('inactive'); ?>
            </a>
            <a href="<?php echo site_url('distributors/status/all/' . $filter_group); ?>"
...
<div id="submenu">
    <div class="collapse clearfix" id="ip-submenu-collapse">
        ...
        <div class="submenu-row">
            <?php echo pager(site_url('distributors/status/' . $this->uri->segment(3)), 'mdl_distributors'); ?>
        </div>

        <div class="submenu-row">
            <div class="btn-group btn-group-sm index-options">
                <a href="<?php echo site_url('distributors/status/active'); ?>"
                   class="btn <?php echo $this->uri->segment(3) == 'active' || !$this->uri->segment(3) ? 'btn-primary' : 'btn-default' ?>">
                    <?php _trans('active'); ?>
                </a>
                <a href="<?php echo site_url('distributors/status/inactive'); ?>"
                   class="btn  <?php echo $this->uri->segment(3) == 'inactive' ? 'btn-primary' : 'btn-default' ?>">
                    <?php _trans('inactive'); ?>
                </a>
                <a href="<?php echo site_url('distributors/status/all'); ?>"
                   class="btn  <?php echo $this->uri->segment(3) == 'all' ? 'btn-primary' : 'btn-default' ?>">
                    <?php _trans('all'); ?>
                </a>
            </div>
...
<div id="content" class="table-content">
    ...
    <div id="filter_results">
        <?php $this->layout->load_view('distributors/partial_distributor_table'); ?>
    </div>
...
<script>
    ...
    {
        window.location = "<?php echo site_url('distributors/status'); ?>/" + status + "/" + index;
    }
