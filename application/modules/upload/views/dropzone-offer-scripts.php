<script>
    ...
    var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
        url: '<?php echo site_url('upload/upload_file/' . $offer->client_id . '/' . $offer->offer_url_key) ?>',
        params: {
        ...
        init: function () {
            thisDropzone = this;
            $.getJSON('<?php echo site_url('upload/upload_file/' . $offer->client_id . '/' . $offer->offer_url_key) ?>',
                function (data) {
    ...
    myDropzone.on('addedfile', function (file) {
        ...
        myDropzone.emit('thumbnail', file,
            '<?php echo base_url('assets/core/img/file-icons/'); ?>' + fileIcon + '.svg');
        createDownloadButton(file, '<?php echo site_url('upload/get_file/' . $offer->offer_url_key . '_') ?>' +
    ...
    myDropzone.on('removedfile', function (file) {
        $.post({
            url: '<?php echo site_url('upload/delete_file/' . $offer->offer_url_key) ?>',
            data: {
