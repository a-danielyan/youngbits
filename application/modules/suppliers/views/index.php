<div id="headerbar">
    ...
    <div class="headerbar-item pull-right visible-lg">
        <div class="btn-group btn-group-sm index-options">
            <a href="<?php echo site_url('suppliers/status/active/' . $filter_group); ?>"
               class="btn <?php echo $this->uri->segment(3) == 'active' || !$this->uri->segment(3) ? 'btn-primary' : 'btn-default' ?>">
                <?php _trans('active'); ?>
            </a>
            <a href="<?php echo site_url('suppliers/status/inactive/' . $filter_group); ?>"
               class="btn  <?php echo $this->uri->segment(3) == 'inactive' ? 'btn-primary' : 'btn-default' ?>">
                <?php _trans('inactive'); ?>
            </a>
            <a href="<?php echo site_url('suppliers/status/all/' . $filter_group); ?>"
...
<script>
    ...
    {
        window.location = "<?php echo site_url('suppliers/status'); ?>/" + status + "/" + index;
    }
