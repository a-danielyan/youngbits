...
<script>
    $(function () {
        ...
        $('#client_change_confirm').click(function () {
            ...
            $.post("<?php echo site_url('offers/ajax/change_client'); ?>", {
...
<div id="change-client" class="modal modal-lg" role="dialog" aria-labelledby="modal_create_offer" aria-hidden="true">
    <form class="modal-content">
        ...
        <div class="modal-body">
            ...
            <input class="hidden" id="offer_id" value="<?php echo $offer_id; ?>">
